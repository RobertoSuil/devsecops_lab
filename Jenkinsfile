			...
			script{
			    ...
			    sh '${DOCKER_EXEC} rm -f zap2'
        		    sh "${DOCKER_EXEC} pull owasp/zap2docker-stable"
                                ...
                                sh '${DOCKER_EXEC} run --add-host="localhost:192.168.70.146"  /home/devsecops1313/Desktop/Jenkins/jenkins_home/tools:/zap/wrk/:wc --rm -i owasp/zap2docker-stable zap-full-scan.py -t "http://zero.webappsecurity.com" -I -r zap_full-scan_report.html -l PASS'	
					publishHTML([
        					allowMissing: false,
